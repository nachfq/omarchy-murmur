...
- [Installation](INSTALLATION.md) — requirements, setup, updates and removal.
- [Usage](USAGE.md) — mixing, Randomize, keyboard controls and saved preferences.
...
- [Sound licenses](../SOUNDS_LICENSES.md) — sources, attribution and regeneration.
